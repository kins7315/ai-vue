        ...
        <div class="sidebar">
            ...
            <div class="ai-assistant-info">
                <div class="breathing-circle">
                    <el-image :src="robotUrl" alt="AI助手" style="width: 25px; height: 25px;" lazy />
                </div>
                <h3 class="assistant-name">老kingAI助手</h3>
            ...
            <div class="emotion-garden">
                ...
                <div class="warm-tips">
                    ...
                    <!-- 治愈小行动卡片 -->
                    <div class="healing-actions" v-if="currentEmotion.keywords">
                        <div class="actions-title">治愈小行动</div>
                        <div class="actions-list">
                            <div v-for="action in currentEmotion.keywords" :key="action" class="action-item">
            ...
            <div class="chat-header">
                <div class="header-left">
                    <div class="chat-avatar">
                        <el-image :src="chatUrl" alt="AI助手" style="width: 30px; height: 30px;" lazy />
                    </div>
                    <div class="chat-info">
                        <h2 class="assistant-name">老kingAI助手</h2>
                        <p>您贴心的AI心理健康助手</p>
                    </div>
                </div>
                <el-button circle @click="createChat" title="新建对话">
                    <el-icon>
                        <Plus />
                    </el-icon>
                </el-button>
            ...
            <div class="chat-messages">
                ...
                <div class="message-item ai-message" v-if="!messages === 0 || messages.length">
                    ...
                    <div class="message-content">
                        ...
                        <div class="message-time">刚刚</div><!-- 后面再添加实时功能 -->
                    </div>
                </div>
                <!-- 消息列表 -->
                <div v-for="msg in messages" :key="msg.id" class="message-item"
                    ...
                    <div class="message-avatar">
                        <el-image v-if="msg.senderType === 1" :src="userUrl" alt="用户"
                            style="width: 18px; height: 18px;" lazy />
                        <el-image v-if="msg.senderType === 2" :src="robotUrl" alt="AI助手"
                            style="width: 18px; height: 18px;" lazy />
                    </div>
                    <div class="message-content">
                        <div class="message-bubble">
            ...
            <div class="chat-input">
                <div class="input-container">
                    ...
                    <div class="input-footer">
                        <span class="">按enter发送，按shift+enter换行</span>
                        <span class="">{{ userMessage.length }}/200</span>
                    </div>
                </div>
                <el-button :disabled="!userMessage.trim() || userMessage.length > 200" class="send-btn" type="primary"
                    @click="sendMessage">
                    <el-icon>
                        <Promotion />
                    </el-icon>
...
const chatUrl = new URL('@/assets/images/like.png', import.meta.url).href
...
const startNewSession = (message) => {
    ...
    if (currentSession.value.sessionTitle === '新对话') {
        sessionParams.sessionTitle = `老kingAI助手 - ${new Date().toLocaleString()}`
    } else {
        // 非新对话，保留原标题
