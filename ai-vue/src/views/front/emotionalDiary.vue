    ...
    <div class="emotionDiary-container">
        <div class="header-section">
            <div class="header-content">
                <el-image :src="imageUrl" alt="like" style="width: 60px; height: 60px;" />
                <h1>情绪日记</h1>
            </div>
        </div>
        <div class="content">
            ...
            <div class="diary-card">
                ...
                <div class="section">
                    ...
                    <div class="rate">
                        <el-rate v-model="diaryForm.moodScore" :text="emotionStatus" :max="10" show-text size="large" />
                    </div>
                </div>
            </div>
            <!-- 主要情绪 -->
            ...
            <div class="diary-card">
                ...
                <div class="detail-form">
                    ...
                    <div class="form-group">
                        ...
                        <el-input v-model="diaryForm.diaryContent" placeholder="写下您今天的想法、感受或发生的有趣的事..." type="textarea"
                            :rows="5" maxLength="1500" show-word-limit></el-input>
                    </div>
                    <!-- 生活指标 -->
