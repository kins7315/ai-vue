    ...
    <div class="articleDetail-container">
        <div class="header-section">
            <div class="header-content">
                <el-image :src="imgUrl" alt="封面图片" class="header-image" lazy />
                <h1>知识文章详情</h1>
            </div>
        </div>
        <div class="content">
            <div class="diary-card">
                ...
                <h1 class="diary-card">{{ articleDetail.title }}</h1>
                <div class="summary-content" v-if="articleDetail.summary">
                    <p>{{ articleDetail.summary }}</p>
                </div>
                <div :style="{ marginTop: '23px' }" class="flex-box">
            ...
            <div class="diary-card">
                ...
                <div class="tags-content" v-if="articleDetail.tagArray && articleDetail.tagArray.length > 0">
                    ...
                    <div class="tags-list">
                        <el-tag v-for="tag in articleDetail.tagArray" :key="tag" effect="light"
...
<script setup>
import imgUrl from '@/assets/images/book.png'
