<template>
    <div class="auth-layout" style="height: 100vh;">
        <div class="left-section" style="height: 100%;">
            <div class="content">
                <h2 class="title">心理AI助手</h2>
                <p class="text">每个深夜，每个焦虑的时候，我们都在这里，不必独自承受，让心与心之间的距离拉近，温暖您的每一天</p>
                <div class="robot">
                    <el-image style="width: 90px; height: 90px;" :src="robotImage" alt="心理AI助手" />
                </div>
            </div>
        </div>
